  ...
  return (
    <div className='home-container'>
      ...
      <div className='product--container'>
        <p className='product--list-title'>Electronics and Accessories</p>
...
const cartItem = [
  ...
  },
  {
    ...
    product_name:
      "7SEVEN®️ Compatible for Tata Sky Remote Original Set Top HD Box and Suitable for SD Tata Play setup Box Remote Control",
  ...
  },
  {
    ...
    product_name:
      "INDIAS®️™️ Electro-Instant Water Geyser A.B.S. Body Shock Proof Can be Used in Bathroom, Kitchen, wash Area, Hotels, Hospital etc.",
    category:
